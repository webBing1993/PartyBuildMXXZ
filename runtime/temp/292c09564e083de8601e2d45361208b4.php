<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"D:\partybuildeb\public/../application/admin\view\wechat\tag.html";i:1492583058;s:65:"D:\partybuildeb\public/../application/admin\view\base\common.html";i:1492583058;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools progress-demo">
                        <button class="ladda-button ladda-button-user btn btn-primary"  data-style="zoom-in">同步标签</button>
                    </div>
                </div>
...
<script>
    $(function(){
        ...
        l.click(function(){
            ...
            $.ajax({
                type: "get",
                url: "<?php echo Url('Wechat/synchronizeTag'); ?>",
