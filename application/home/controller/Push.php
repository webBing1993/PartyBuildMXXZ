...
class Push extends Controller{
    ...
    public function cron(){
        ...
        //每日一课的图片 URL跟 ID
        $image_url = 'http://mmbiz.qpic.cn/mmbiz_png/WWMYMsgyNyWu9CIaPOwRicCL4r5cEtn506kw5JhUDbVQVG8gjp9VSicib48XZJicqoJeuLADRBIqKOvNboGticibdNQQ/0?wx_fmt=png';
...
//            //先上传素材 media_id
            ...
            if (!empty($info['media_id'])){
                foreach ($list as $k => $v){
                    $push ->where('focus_main',$v['id']) ->update(['status' => 1]);
                }
            }
        }
        //消息群发
